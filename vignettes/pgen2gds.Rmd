...
[PLINK 2](https://www.cog-genomics.org/plink/2.0/) is one of the most widely
...
The **pgen2gds** package bridges these two ecosystems by converting PLINK 2
...
The package ships with small example PLINK 2 files:
...
The main function, `seqPGEN2GDS()`, converts a set of PLINK 2 files into a
